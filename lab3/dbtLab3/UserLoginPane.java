...
public class UserLoginPane extends BasicPane {
    ...
    class ActionHandler implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            for (User u: db.getUser(userId)){
                CurrentUser.instance().loginAs(u.name);
            }
            if (!CurrentUser.instance().isLoggedIn()){
                JOptionPane.showMessageDialog(null, "User: " + userId + " does not exits");
            } else {
                JOptionPane.showMessageDialog(null, "Now logged in as: " + userId);
            }
        }
    }
}
